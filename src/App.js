...
{/*6 image che to vdharvi hoy to 6 che tya change krvo*/}
  ...
  return (
    <div>
      {products.length > 0 && <div className="products">
        {products.slice(page * 10 - 6, page * 10).map((prod) => {
          return <span className="products__single" key={prod.id} style={{height:"400px"}}>
            <img src={prod.thumbnail} alt={prod.title} height="10px" /> {/* alt is imp */}
            <span>
              {prod.title}
            </span>
          </span>
